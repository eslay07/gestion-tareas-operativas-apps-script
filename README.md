...
- [Modelo de datos general](#modelo-de-datos-general)
...
- [Uso profesional del proyecto](#uso-profesional-del-proyecto)
- [Autor](#autor)
- [Licencia](#licencia)
...
- Criticidad: baja, media, alta y crítica.
- Frecuencia: única, diaria, semanal y mensual.
- Fecha de vencimiento.
- Hora de recordatorio.
- Tareas pendientes, vencidas, de hoy y de la semana.
- Tareas completadas y reactivación de tareas.
...
- Clasificación de estado: nuevo, pendiente, urgente, crítico o compartida.
...
- Exportación de código, detalle, cantidad, proveedor, orden de compra, fila de origen y fecha de exportación.
